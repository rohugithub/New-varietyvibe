        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end space-x-2">
              <Button
                type="button"
                className="text-lg bg-[#000000a3] font-light text-white hover:bg-blue-600 hover:text-white"
                variant="outline"
              ...
              <Button type="submit" disabled={saving || uploadingImage} className="text-lg  py-4 font-light hover:bg-blue-700 hover:text-white">
        ...
        <Card className="mt-6">
          <CardHeader>
            <CardTitle className="flex justify-between items-center">
              ...
              <Button variant="outline" size="sm" className="text-md hover:bg-blue-600 hover:text-white" onClick={() => setDebugLogs([])}>
                Clear
              </Button>
            </CardTitle>
          </CardHeader>
