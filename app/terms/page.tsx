...
export default function TermsPage() {
  return (
    <div>
      ...
      <main className="container mx-auto max-w-5xl px-6 py-10 space-y-12">
        {/* ------------ Title ------------ */}
