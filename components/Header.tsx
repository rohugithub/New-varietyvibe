...
import { Search, MapPin, ChevronDown,ShoppingCart, Heart, User, Menu, X } from "lucide-react"
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              {session ? (
                ...
                <Button variant="ghost" size="icon" className="text-white hover:bg-blue-600" onClick={() => setIsAuthOpen(true)}>
                  <User className="h-5 w-5" />
                </Button>
              )}
            ...
            <div className="md:hidden py-4 border-t border-blue-600 animate-in slide-in-from-top-2">
              <div className="flex flex-col space-y-4">
                <div className="relative">
                  ...
                  <Input placeholder="Search products..." className="pl-10 bg-white text-black border-0" />
                </div>
                <Link href="/" className="hover:text-blue-200">Home</Link>
                <Link href="/electronics" className="hover:text-blue-200">Electronics</Link>
                <Link href="/appliances" className="hover:text-blue-200">Appliances</Link>
