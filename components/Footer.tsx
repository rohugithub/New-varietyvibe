      ...
      <div className="bg-[#b74d80e0]">
        <div className="container mx-auto px-4 md:px-8 py-8 md:py-16">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            {/* Shop Links */}
            <div>
              <h3 className="text-xl md:text-3xl font-semibold mb-4 text-white">Shop</h3>
              <ul className="space-y-2 text-sm md:text-lg text-white">
                <li><Link href="/products" className="text-white hover:text-gray-400">All Products</Link></li>
                <li><Link href="/electronics" className="text-white hover:text-gray-400">Electronics</Link></li>
                <li><Link href="/appliances" className="text-white hover:text-gray-400">Appliances</Link></li>
                <li><Link href="/it-products" className="text-white hover:text-gray-400">IT Products</Link></li>
            ...
            {/* Quick Links */}
            <div>
              <h3 className="text-xl md:text-3xl font-medium mb-4 text-white">Quick Links</h3>
              <ul className="space-y-2 text-sm md:text-lg text-white">
                <li><Link href="/about" className="text-white hover:text-gray-400">About Us</Link></li>
                <li><Link href="/contact" className="text-white hover:text-gray-400">Contact Us</Link></li>
                {session?.user && (
                  <li>
                ...
                <li><Link href="/auth/agent" className="text-white hover:text-gray-400">Agent Login</Link></li>
                <li><Link href="/auth/merchant" className="text-white hover:text-gray-400">Merchant Login</Link></li>
              </ul>
            </div>

            {/* Customer Policy */}
            <div>
              <h3 className="text-xl md:text-3xl font-medium mb-4 text-white">Customer Policy</h3>
              <ul className="space-y-2 text-sm md:text-lg text-blue-100">
                <li><Link href="/terms" className="text-white hover:text-gray-400">Terms & Conditions</Link></li>
                <li><Link href="/privacy" className="text-white hover:text-gray-400">Privacy Policy</Link></li>
                <li><Link href="/shipping" className="text-white hover:text-gray-400">Shipping & Delivery</Link></li>
                <li><Link href="/returns" className="text-white hover:text-gray-400">Returns & Exchanges</Link></li>
                <li><Link href="/faq" className="text-white hover:text-gray-400">FAQ</Link></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className=" ">
          <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-6 px-4 py-6">
            <div className="flex flex-col sm:flex-row items-center gap-2 text-center sm:text-left text-white">
              <div className="flex items-center gap-2">
            ...
            <div className="text-center text-sm text-white">© 2025 VARIETY VIBES Ltd. All rights reserved.</div>
